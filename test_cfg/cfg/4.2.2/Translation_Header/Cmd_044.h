/*============================================================================*/
/* Project      = AUTOSAR Renesas M3N MCAL Components                          */
/* File name    = Cmd_044.h                                                   */
/* SVN Revision =                                                             */
/* Status       = Draft                                                       */
/*============================================================================*/
...
/*============================================================================*/
/* Purpose:                                                                   */
/* This translation file maps device file macros with user defined (Renesas_  */
/* F1x) macros. Generator uses this translation file inorder to avoid         */
/* hardcoding of base addressess or the usage of device header file macros    */
/* directly.                                                                  */
/*                                                                            */
/*============================================================================*/
/*                                                                            */
...
/*
 * V1.0.0:   24-Mar-2016 : Initial version
 */
/******************************************************************************/
...
**                      Global Data Types                                     **
*******************************************************************************/
#ifndef __M3N_TRANSLATION_H
#define __M3N_TRANSLATION_H

#define RENESAS_INDT              INDT
